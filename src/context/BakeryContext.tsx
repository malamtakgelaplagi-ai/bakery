...
const INITIAL_SUPPLIERS: Supplier[] = [
  ...
  {
    id: 'sup-5',
    name: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    contactPerson: 'Pak Hendra Gunawan',
    phone: '081298112233',
    address: 'Jl. Surya Sumantri No. 88, Bandung',
    notes: 'Suplier resmi Nescafé Classic, Susu UHT Ultra Milk, Sirup Hazelnut impor/lokal & Cup Takeaway',
    suppliedIngredients: ['ing-21', 'ing-22', 'ing-23', 'ing-24', 'ing-25', 'ing-26', 'ing-27', 'ing-28', 'ing-29', 'ing-30'],
  },
];
...
const INITIAL_INGREDIENTS: Ingredient[] = [
  ...
  },
  {
    id: 'ing-21',
    sku: 'RAW-KOP-NES',
    name: 'Nescafé Classic (Kopi Murni Instan)',
    category: 'Bahan Utama',
    buyUnit: 'jar (100g)',
    recipeUnit: 'g',
    conversionFactor: 100,
    latestBuyPrice: 50000,
    costPerRecipeUnit: 500, // 2g = Rp 1.000
    stockInRecipeUnit: 500,
    minStockInRecipeUnit: 100,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Kopi instan murni 100% robusta aroma mantap tanpa ampas, 2g per porsi',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-22',
    sku: 'RAW-SSU-ULT',
    name: 'Ultra Milk Plain Full Cream (UHT Liquid)',
    category: 'Dairy & Lemak',
    buyUnit: 'karton 1 liter (1000ml)',
    recipeUnit: 'ml',
    conversionFactor: 1000,
    latestBuyPrice: 12000,
    costPerRecipeUnit: 12, // 100ml = Rp 1.200
    stockInRecipeUnit: 10000,
    minStockInRecipeUnit: 2000,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Susu segar UHT creamy gurih berkualitas tinggi, 100ml per porsi',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-23',
    sku: 'RAW-SYR-EKO',
    name: 'Syrup Hazelnut Ekonomis (Varian Regular)',
    category: 'Perasa, Pewarna & Rempah',
    buyUnit: 'botol (1000ml)',
    recipeUnit: 'ml',
    conversionFactor: 1000,
    latestBuyPrice: 70000,
    costPerRecipeUnit: 70, // 20ml = Rp 1.400
    stockInRecipeUnit: 2000,
    minStockInRecipeUnit: 400,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Sirup rasa hazelnut manis legit untuk kopi susu level ekonomis / regular, 20ml per cup',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-24',
    sku: 'RAW-SYR-STD',
    name: 'Syrup Hazelnut Standar (Davinci / Denali)',
    category: 'Perasa, Pewarna & Rempah',
    buyUnit: 'botol (750ml)',
    recipeUnit: 'ml',
    conversionFactor: 750,
    latestBuyPrice: 75000,
    costPerRecipeUnit: 100, // 20ml = Rp 2.000
    stockInRecipeUnit: 1500,
    minStockInRecipeUnit: 300,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Sirup hazelnut standar barista cafe, wangi kacang hazelnut panggang seimbang, 20ml per cup',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-25',
    sku: 'RAW-SYR-PRM',
    name: 'Syrup Hazelnut Premium Gourmet (Monin / 1883)',
    category: 'Perasa, Pewarna & Rempah',
    buyUnit: 'botol (700ml)',
    recipeUnit: 'ml',
    conversionFactor: 700,
    latestBuyPrice: 119000,
    costPerRecipeUnit: 170, // 20ml = Rp 3.400
    stockInRecipeUnit: 1400,
    minStockInRecipeUnit: 200,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Sirup hazelnut impor gourmet artisan premium aroma roasted hazelnut mewah pekat, 20ml per cup',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-26',
    sku: 'RAW-ICE-KRS',
    name: 'Es Kristal Higienis (Tube Ice)',
    category: 'Bahan Utama',
    buyUnit: 'pack (5kg)',
    recipeUnit: 'g',
    conversionFactor: 5000,
    latestBuyPrice: 15000,
    costPerRecipeUnit: 3, // 100g = Rp 300
    stockInRecipeUnit: 20000,
    minStockInRecipeUnit: 5000,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Es kristal bening higienis foodgrade untuk minuman dingin, 100g per porsi',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-27',
    sku: 'RAW-AIR-GLN',
    name: 'Air Mineral / Air Panas Galon Foodgrade',
    category: 'Bahan Utama',
    buyUnit: 'galon (19000ml)',
    recipeUnit: 'ml',
    conversionFactor: 19000,
    latestBuyPrice: 31666.67,
    costPerRecipeUnit: 1.66667, // 30ml = Rp 50
    stockInRecipeUnit: 38000,
    minStockInRecipeUnit: 9500,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Air mineral panas untuk melarutkan 2g Nescafé Classic, 30ml per porsi',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-28',
    sku: 'PKG-CUP-REG',
    name: 'Set Cup Takeaway 14oz + Flat Lid + Sedotan (Ekonomis)',
    category: 'Kemasan & Packaging',
    buyUnit: 'pack (50 set)',
    recipeUnit: 'pcs',
    conversionFactor: 50,
    latestBuyPrice: 45000,
    costPerRecipeUnit: 900, // Rp 900 per set
    stockInRecipeUnit: 150,
    minStockInRecipeUnit: 30,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Kemasan cup plastik transparan 14oz + tutup datar + sedotan steril untuk Kopi Susu Regular',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-29',
    sku: 'PKG-CUP-STD',
    name: 'Set Cup Sablon PUSAKA 16oz + Seal Lid + Sedotan (Standar)',
    category: 'Kemasan & Packaging',
    buyUnit: 'pack (50 set)',
    recipeUnit: 'pcs',
    conversionFactor: 50,
    latestBuyPrice: 50000,
    costPerRecipeUnit: 1000, // Rp 1.000 per set
    stockInRecipeUnit: 200,
    minStockInRecipeUnit: 40,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Kemasan cup 16oz dengan sablon logo PUSAKA + cup sealer / dome lid + sedotan steril untuk Kopi Susu Lumo',
    updatedAt: '2026-09-15',
  },
  {
    id: 'ing-30',
    sku: 'PKG-CUP-PRM',
    name: 'Set Cup Tebal PP Injection 16-22oz + Lid Hat + Sleeve + Sedotan (Premium)',
    category: 'Kemasan & Packaging',
    buyUnit: 'pack (50 set)',
    recipeUnit: 'pcs',
    conversionFactor: 50,
    latestBuyPrice: 60000,
    costPerRecipeUnit: 1200, // Rp 1.200 per set
    stockInRecipeUnit: 100,
    minStockInRecipeUnit: 25,
    defaultSupplierId: 'sup-5',
    defaultSupplierName: 'Distributor Kopi, Susu & Sirup Barista Mandiri',
    status: 'active',
    notes: 'Kemasan cup tebal PP frosted/injection + lid heart plug/hat + sleeve eksklusif + sedotan ramah lingkungan untuk Kopi Susu Premium',
    updatedAt: '2026-09-15',
  }
];
...
const INITIAL_RECIPES: Recipe[] = [
  ...
  {
    id: 'rec-5',
    name: 'Kopi Susu Hazelnut - Regular (Ekonomis)',
    category: 'Kopi & Minuman',
    description: 'Resep dasar Kopi Susu Hazelnut Ekonomis 14oz: Nescafé Classic 2g, Ultra Milk 100ml, Syrup Hazelnut Ekonomis 20ml, Es 100g, Air 30ml, Cup Takeaway 14oz.',
    currentVersionId: 'ver-5-0',
    ...
    versions: [
      {
        id: 'ver-5-0',
        versionNumber: 'v1.0',
        changeLog: 'Resep standar Ekonomis: HPP Bahan Rp 3.950 + Cup Rp 900 = Rp 4.850, dibulatkan usaha jadi HPP Rp 5.000. Harga Jual Rp 10.000 (Laba Rp 5.000 / Margin 50%). Cocok untuk menarik pelanggan.',
        targetBatterWeightGram: 252, // 2g kopi + 100ml susu + 20ml sirup + 100g es + 30ml air
        targetBakedWeightGram: 250,
        yieldQty: 1, // 1 cup
        items: [
          { id: 'b-1', ingredientId: 'ing-21', ingredientName: 'Nescafé Classic (Kopi Murni Instan)', quantity: 2, recipeUnit: 'g', unitCostSnapshot: 500, cost: 1000 },
          { id: 'b-2', ingredientId: 'ing-22', ingredientName: 'Ultra Milk Plain Full Cream', quantity: 100, recipeUnit: 'ml', unitCostSnapshot: 12, cost: 1200 },
          { id: 'b-3', ingredientId: 'ing-23', ingredientName: 'Syrup Hazelnut Ekonomis (Regular)', quantity: 20, recipeUnit: 'ml', unitCostSnapshot: 70, cost: 1400 },
          { id: 'b-4', ingredientId: 'ing-26', ingredientName: 'Es Kristal Higienis (Tube Ice)', quantity: 100, recipeUnit: 'g', unitCostSnapshot: 3, cost: 300 },
          { id: 'b-5', ingredientId: 'ing-27', ingredientName: 'Air Mineral / Air Panas Galon', quantity: 30, recipeUnit: 'ml', unitCostSnapshot: 1.66667, cost: 50 },
        ],
        packaging: [
          { id: 'pkg-1', ingredientId: 'ing-28', name: 'Set Cup Takeaway 14oz + Flat Lid + Sedotan', quantity: 1, unitCost: 900, totalCost: 900 },
        ],
        directCosts: [
          { id: 'dc-1', name: 'Biaya Seduh & Pembulatan Usaha', costType: 'per_unit', amount: 150 },
        ],
        totalRawCost: 3950,
        totalPackagingCost: 900,
        totalDirectCost: 150,
        totalHppPerUnit: 5000,
        notes: 'HPP riil Rp 4.850 dibulatkan menjadi Rp 5.000. Harga Jual Rp 10.000. Margin 50%. Target omzet 100 cup = Rp 1.000.000, Laba kotor = Rp 500.000.',
        createdAt: '2026-09-15',
        createdBy: 'Barista PUSAKA',
      }
    ]
  },
  {
    id: 'rec-6',
    name: 'Kopi Susu Hazelnut - Lumo (Standar) ⭐',
    category: 'Kopi & Minuman',
    description: 'Resep utama hero product Kopi Susu Hazelnut Standar Lumo 16oz: Nescafé Classic 2g, Ultra Milk 100ml, Syrup Hazelnut Standar 20ml, Es 100g, Air 30ml, Cup Sablon 16oz.',
    currentVersionId: 'ver-6-0',
    createdAt: '2026-09-15',
    updatedAt: '2026-09-15',
    versions: [
      {
        id: 'ver-6-0',
        versionNumber: 'v1.0',
        changeLog: 'Resep standar utama Lumo: HPP Bahan Rp 4.550 + Cup Rp 1.000 = Rp 5.550, dibulatkan usaha jadi HPP Rp 5.500. Harga Jual Rp 12.000 (Laba Rp 6.500 / Margin 54%).',
        targetBatterWeightGram: 252,
        targetBakedWeightGram: 250,
        yieldQty: 1,
        items: [
          { id: 'b-1', ingredientId: 'ing-21', ingredientName: 'Nescafé Classic (Kopi Murni Instan)', quantity: 2, recipeUnit: 'g', unitCostSnapshot: 500, cost: 1000 },
          { id: 'b-2', ingredientId: 'ing-22', ingredientName: 'Ultra Milk Plain Full Cream', quantity: 100, recipeUnit: 'ml', unitCostSnapshot: 12, cost: 1200 },
          { id: 'b-3', ingredientId: 'ing-24', ingredientName: 'Syrup Hazelnut Standar (Davinci/Denali)', quantity: 20, recipeUnit: 'ml', unitCostSnapshot: 100, cost: 2000 },
          { id: 'b-4', ingredientId: 'ing-26', ingredientName: 'Es Kristal Higienis (Tube Ice)', quantity: 100, recipeUnit: 'g', unitCostSnapshot: 3, cost: 300 },
          { id: 'b-5', ingredientId: 'ing-27', ingredientName: 'Air Mineral / Air Panas Galon', quantity: 30, recipeUnit: 'ml', unitCostSnapshot: 1.66667, cost: 50 },
        ],
        packaging: [
          { id: 'pkg-1', ingredientId: 'ing-29', name: 'Set Cup Sablon PUSAKA 16oz + Seal Lid + Sedotan', quantity: 1, unitCost: 1000, totalCost: 1000 },
        ],
        directCosts: [
          { id: 'dc-1', name: 'Penyesuaian Pembulatan Usaha', costType: 'per_unit', amount: -50 },
        ],
        totalRawCost: 4550,
        totalPackagingCost: 1000,
        totalDirectCost: -50,
        totalHppPerUnit: 5500,
        notes: 'HPP riil Rp 5.550 dibulatkan menjadi Rp 5.500. Harga Jual Rp 12.000 (Hero Product). Margin ~54%. Target omzet 100 cup = Rp 1.200.000, Laba kotor = Rp 650.000.',
        createdAt: '2026-09-15',
        createdBy: 'Barista PUSAKA',
      }
    ]
  ...
  {
    id: 'rec-7',
    name: 'Kopi Susu Hazelnut - Premium',
    category: 'Kopi & Minuman',
    description: 'Resep eksklusif Kopi Susu Hazelnut Premium 16-22oz: Nescafé Classic 2g, Ultra Milk 100ml, Syrup Hazelnut Gourmet 20ml, Es 100g, Air 30ml, Cup Tebal Injection + Sleeve.',
    currentVersionId: 'ver-7-0',
    createdAt: '2026-09-15',
    updatedAt: '2026-09-15',
    versions: [
      {
        id: 'ver-7-0',
        versionNumber: 'v1.0',
        changeLog: 'Resep premium eksklusif: HPP Bahan Rp 5.950 + Cup Premium Rp 1.200 = Rp 7.150, dibulatkan usaha jadi HPP Rp 7.500. Harga Jual Rp 15.000 (Laba Rp 7.500 / Margin 50%).',
        targetBatterWeightGram: 252,
        targetBakedWeightGram: 250,
        yieldQty: 1,
        items: [
          { id: 'b-1', ingredientId: 'ing-21', ingredientName: 'Nescafé Classic (Kopi Murni Instan)', quantity: 2, recipeUnit: 'g', unitCostSnapshot: 500, cost: 1000 },
          { id: 'b-2', ingredientId: 'ing-22', ingredientName: 'Ultra Milk Plain Full Cream', quantity: 100, recipeUnit: 'ml', unitCostSnapshot: 12, cost: 1200 },
          { id: 'b-3', ingredientId: 'ing-25', ingredientName: 'Syrup Hazelnut Premium Gourmet (Monin)', quantity: 20, recipeUnit: 'ml', unitCostSnapshot: 170, cost: 3400 },
          { id: 'b-4', ingredientId: 'ing-26', ingredientName: 'Es Kristal Higienis (Tube Ice)', quantity: 100, recipeUnit: 'g', unitCostSnapshot: 3, cost: 300 },
          { id: 'b-5', ingredientId: 'ing-27', ingredientName: 'Air Mineral / Air Panas Galon', quantity: 30, recipeUnit: 'ml', unitCostSnapshot: 1.66667, cost: 50 },
        ],
        packaging: [
          { id: 'pkg-1', ingredientId: 'ing-30', name: 'Set Cup Tebal PP Injection + Lid Hat + Sleeve + Sedotan', quantity: 1, unitCost: 1200, totalCost: 1200 },
        ],
        directCosts: [
          { id: 'dc-1', name: 'Artisan Barista & Pembulatan Usaha', costType: 'per_unit', amount: 350 },
        ],
        totalRawCost: 5950,
        totalPackagingCost: 1200,
        totalDirectCost: 350,
        totalHppPerUnit: 7500,
        notes: 'HPP riil Rp 7.150 dibulatkan menjadi Rp 7.500. Harga Jual Rp 15.000. Margin 50%. Target omzet 100 cup = Rp 1.500.000, Laba kotor = Rp 750.000.',
        createdAt: '2026-09-15',
        createdBy: 'Barista PUSAKA',
      }
    ]
...
const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: 'Kopi Susu Hazelnut - Regular (Ekonomis)',
    category: 'Kopi & Minuman',
    sizeSpec: 'Cup 14 oz (Ekonomis)',
    bakedWeightGram: 250,
    recipeId: 'rec-5',
    recipeVersionId: 'ver-5-0',
    sellingPrice: 10000,
    baseHpp: 5000.0,
    grossMarginPercent: 50.0,
    stockFinishedGoods: 30,
    minStockFinishedGoods: 10,
    status: 'active',
    description: 'Kopi Susu Hazelnut level Ekonomis: paduan Nescafé Classic, Ultra Milk, es kristal, dan sirup hazelnut manis legit dalam cup 14oz. Pilihan hemat dan terjangkau!',
    shelfLifeDays: 1,
    image: '/products/kopi-susu-hazelnut.jpg',
  },
  {
    id: 'prod-7',
    sku: 'KSH-LUM',
    name: 'Kopi Susu Hazelnut - Lumo (Standar) ⭐',
    category: 'Kopi & Minuman',
    sizeSpec: 'Cup Sablon 16 oz (Menu Utama PUSAKA)',
    bakedWeightGram: 300,
    recipeId: 'rec-6',
    recipeVersionId: 'ver-6-0',
    sellingPrice: 12000,
    baseHpp: 5500.0,
    grossMarginPercent: 54.2,
    stockFinishedGoods: 45,
    minStockFinishedGoods: 15,
    status: 'active',
    description: 'Hero product terfavorit: racikan mantap kopi Nescafé Classic, Ultra Milk creamy, dan sirup hazelnut standar barista cafe dalam cup 16oz eksklusif PUSAKA.',
    shelfLifeDays: 1,
    image: '/products/kopi-susu-hazelnut.jpg',
  },
  {
    ...
    name: 'Kopi Susu Hazelnut - Premium',
    category: 'Kopi & Minuman',
    sizeSpec: 'Cup Injection Tebal 16-22 oz + Sleeve',
    bakedWeightGram: 350,
    recipeId: 'rec-7',
    recipeVersionId: 'ver-7-0',
    sellingPrice: 15000,
    baseHpp: 7500.0,
    grossMarginPercent: 50.0,
    stockFinishedGoods: 20,
    minStockFinishedGoods: 5,
    status: 'active',
    description: 'Racikan kopi susu premium eksklusif dengan syrup hazelnut gourmet artisan impor, Ultra Milk gurih creamy, dan cup injection tebal elegan.',
    shelfLifeDays: 1,
    image: '/products/kopi-susu-hazelnut.jpg',
  },
];
...
export const BakeryProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [suppliers, setSuppliers] = useState<Supplier[]>(() => {
    ...
    if (!Array.isArray(list)) return INITIAL_SUPPLIERS;
    const existingIds = new Set(list.map(s => s.id));
    const missingInit = INITIAL_SUPPLIERS.filter(s => !existingIds.has(s.id));
    return [...list, ...missingInit];
  });
